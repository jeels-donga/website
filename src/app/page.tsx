...
const Home = () => {
  ...
  return (
    <div className="overflow-hidden">
      {/* Hero Section */}
      <div className="relative min-h-screen bg-gradient-to-t from-gray-900 to-blue-900">
        ...
        <div className="absolute inset-0 overflow-hidden">
          {Array.from({ length: 20 }).map((_, i) => (
            <div
              key={i}
              className={`absolute w-${Math.floor(Math.random() * 16 + 4)} h-${Math.floor(Math.random() * 16 + 4)}
        ...
        <div className="relative z-10">
          <Slider {...settings}>
            ...
            { title: "Our Resources", description: " Over 50+ resources deployed across diverse projects in the last two years" },
              { title: "Our Partners", description: "             90+ projects completed with cutting-edge technologies and 20+ industries served" }
            ].map((section, idx) => (
              <div key={idx} className="flex flex-col items-center justify-center py-16 px-6 text-white animate__animated animate__fadeIn animate__delay-1s text-center">
      ...
      <div className="relative py-20 px-4 bg-gray-900  ">
        <div className="absolute inset-0 bg-gray-900 animate-gradient-x"></div>
      ...
      {/* Work Steps */}
      <div className="py-20 px-4  bg-gradient-to-b from-gray-900 to-blue-900">
      ...
      {/* Expertise Section */}
      <div className="py-20 px-4  bg-gradient-to-t from-gray-900 to-blue-900">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[1, 2, 3].map((client) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-white mb-2">Client {client}</h3>
                <p className="text-gray-400">Innovative solutions for tomorrow&apos;s challenges.</p>
              </div>
            ))}
          </div>
        </div>
